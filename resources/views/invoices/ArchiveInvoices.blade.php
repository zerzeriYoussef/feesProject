                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#" onclick="deleteInvoice('{{ $invoice->id }}')">
    ...
    <div class="modal fade" id="delete_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ URL::route('destro', [$invoice->id]) }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
...
<script>
    function deleteInvoice(id) {
        ...
        // Set the value of the invoice_id input
        invoiceIdInput.value = id;

        // Display the form (assuming it's initially hidden)
