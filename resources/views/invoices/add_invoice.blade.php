                ...
                if (SectionId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="product"]').append('<option value="" selected disabled>Select Product</option>'); // Add a default option
                            $.each(data, function(key, value) {
                                $('select[name="product"]').append('<option value="' + key + '">' + value + '</option>');
                            });
                        },
                        error: function(xhr, status, error) {
                            console.log('AJAX Error: ' + status + ' ' + error); // Log the error
                        }
                    });
                } else {
                    console.log('No section selected'); // Log if no section is selected
                }
            });
        });
    </script>
