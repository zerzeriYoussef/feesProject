...
@section('content')
    ...
    <div class="row" style="max-width: 100%;">
        <!--div-->
        <div class="col-xl-12" style="max-width: 100%;">
            <div class="card mg-b-20" style="max-width: 100%;">
                <div class="card-header pb-0" style="max-width: 100%;">
                    <a href="{{ route('create') }}" class="modal-effect btn btn-sm btn-primary" style="color:white"><i class="fas fa-plus"></i>&nbsp; ADD New Invoice</a>
                    
                        <a class="modal-effect btn btn-sm btn-primary" href="{{ url('export_invoices') }}" style="color:white"><i class="fas fa-file-download"></i>&nbsp; export to Excel</a>
                    
                </div>
                <div class="card-body" style="max-width: 100%;">
                    <div class="table-responsive" style="max-width: 100%;">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50' style="text-align: center; max-width: 100%; ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Cas</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="invoice_id" id="invoice_id" value=""> <!-- 5dha valuer bel script louta -->
                </div>
