                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab4">
                                            ...
                                            @endif
                                        @endforeach
                                        <td>{{ $k }}</td>                                                            <th scope="row">product</th>
                                                ...
                                                <table class="table center-aligned-table mb-0 table-hover"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($details as $x)
                                                            @if($x->Section==$invoices->section_id)
                                                            <?php $i++; ?>
                                                            <tr>
                                                                <td>{{ $i }}</td>
                                                                <td>{{ $x->invoice_number }}</td>
                                                                @foreach ($products as $p)
                                            @if($x->id==$invoices->product)
                                                @php
                                                    $k=$p->Product_name;
                                                @endphp
                                            @endif
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{ url('InvoicesDetails/openfile') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"
                                                                        ...
                                                                        <a class="btn btn-outline-info btn-sm"
                                                                            ...
                                                                            <button class="btn btn-outline-danger btn-sm"
                                                                                ...
                                                                                data-target="#delete_file" text-color="red">حذف</button>
