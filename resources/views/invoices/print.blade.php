                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <p>sidie achour, nabeul Town, 8000, Country tunisia<br>
                                    Tel No: 58 712 970<br>
                                    Email: youssefzerzeri2@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">printed by</label>
                                <div class="billed-to">
                                @if (Auth::check())
...
@section('js')
    ...
    <?php use Illuminate\Support\Facades\Notification; 
